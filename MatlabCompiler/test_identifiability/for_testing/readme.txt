test_identifiability MATLAB Python Package
...
2. Installing the test_identifiability Package

A. Change to the directory that contains the file setup.py and the subdirectory 
test_identifiability. If you do not have write permissions, copy all its contents to a 
...
3. Using the test_identifiability Package

The test_identifiability package is on your Python path. To import it into a Python 
